...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="DQN_Wrong_output">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
        ...
        <node id="n8">
            <attr name="layout">
                <string>885 476 37 24</string>
            </attr>
        </node>
        <node id="n9">
            <attr name="layout">
                <string>843 640 110 24</string>
            </attr>
        </node>
        <edge from="n0" to="n0">
            <attr name="label">
        ...
        <edge from="n1" to="n1">
            <attr name="label">
                <string>let:action_indication = false</string>
            </attr>
        </edge>
        <edge from="n1" to="n1">
            <attr name="label">
        ...
        <edge from="n5" to="n8">
            ...
            <attr name="layout">
                <string>506 -59 875 130 907 473 11</string>
            </attr>
        </edge>
        <edge from="n5" to="n4">
            <attr name="label">
        ...
        <edge from="n8" to="n5">
            ...
            <attr name="layout">
                <string>461 -59 898 473 867 130 11</string>
            </attr>
        </edge>
        <edge from="n8" to="n8">
            <attr name="label">
