...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="DQN_Suboptimal_exploration_rate_2">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
        ...
        <edge from="n3" to="n3">
            <attr name="label">
                <string>let:update_exploration_rate = false</string>
            </attr>
        </edge>
        <edge from="n4" to="n4">
            <attr name="label">
