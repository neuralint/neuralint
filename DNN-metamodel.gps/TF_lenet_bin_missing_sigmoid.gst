...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="TF_lenet_bin_missing_sigmoid">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
        ...
        <node id="n34">
            <attr name="layout">
                <string>3167 37 46 36</string>
            </attr>
        </node>
        <node id="n35">
            <attr name="layout">
                <string>65 98 150 90</string>
            </attr>
        </node>
        <node id="n36">
            <attr name="layout">
                <string>39 269 180 90</string>
            </attr>
        </node>
        <node id="n37">
            <attr name="layout">
                <string>266 244 85 36</string>
            </attr>
        </node>
        <node id="n38">
            <attr name="layout">
                <string>82 432 108 54</string>
            </attr>
        </node>
        <node id="n39">
            <attr name="layout">
                <string>288 397 102 36</string>
            </attr>
        </node>
        <edge from="n0" to="n35">
            <attr name="label">
