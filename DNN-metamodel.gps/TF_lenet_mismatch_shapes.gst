...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="TF_lenet_mismatch_shapes">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
        ...
        <node id="n18">
            <attr name="layout">
                <string>1904 13 84 180</string>
            </attr>
        </node>
        <node id="n19">
            <attr name="layout">
                <string>1884 258 141 126</string>
            </attr>
        </node>
        <node id="n20">
            <attr name="layout">
                <string>2099 14 98 144</string>
            </attr>
        </node>
        <node id="n21">
            <attr name="layout">
                <string>2102 274 99 36</string>
            </attr>
        </node>
        <node id="n22">
            <attr name="layout">
        ...
        <edge from="n20" to="n20">
            <attr name="label">
                <string>let:out_dim1 = int:2048</string>
            </attr>
        </edge>
        <edge from="n20" to="n20">
            <attr name="label">
        ...
        <edge from="n21" to="n21">
            <attr name="label">
                <string>let:type = string:"reshape"</string>
            </attr>
        </edge>
