...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="TF_lenet_missing_reshape-2">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
        ...
        <node id="n18">
            <attr name="layout">
                <string>1907 44 84 216</string>
            </attr>
        </node>
        <node id="n19">
            <attr name="layout">
                <string>1871 318 141 126</string>
            </attr>
        </node>
        <node id="n22">
            <attr name="layout">
                <string>2337 26 91 144</string>
            </attr>
        </node>
        <node id="n23">
            <attr name="layout">
                <string>2233 245 87 36</string>
            </attr>
        </node>
        <node id="n24">
            <attr name="layout">
                <string>2253 348 164 36</string>
            </attr>
        </node>
        <node id="n25">
            <attr name="layout">
                <string>2395 241 110 36</string>
            </attr>
        </node>
        <node id="n26">
            <attr name="layout">
                <string>2543 24 91 144</string>
            </attr>
        </node>
        <node id="n27">
            <attr name="layout">
                <string>2538 242 104 72</string>
            </attr>
        </node>
        <node id="n28">
            <attr name="layout">
                <string>2742 -14 91 144</string>
            </attr>
        </node>
        <node id="n29">
            <attr name="layout">
        ...
        <node id="n35">
            <attr name="layout">
                <string>114 76 150 90</string>
            </attr>
        </node>
        <node id="n36">
            <attr name="layout">
                <string>22 211 184 90</string>
            </attr>
        </node>
        <node id="n37">
            <attr name="layout">
                <string>284 224 85 36</string>
            </attr>
        </node>
        <node id="n38">
            <attr name="layout">
                <string>231 335 108 54</string>
            </attr>
        </node>
        <node id="n39">
            <attr name="layout">
                <string>48 369 102 36</string>
            </attr>
        </node>
        <edge from="n0" to="n2">
            <attr name="label">
        ...
        <edge from="n22" to="n22">
            <attr name="label">
                <string>let:out_dim0 = int:49</string>
            </attr>
        </edge>
        ...
        <edge from="n22" to="n22">
            <attr name="label">
                <string>let:in_dim1 = int:2048</string>
            </attr>
        </edge>
        <edge from="n22" to="n22">
            <attr name="label">
        ...
        <edge from="n22" to="n22">
            <attr name="label">
                <string>let:in_dim0 = int:49</string>
            </attr>
        </edge>
        <edge from="n22" to="n22">
            <attr name="label">
