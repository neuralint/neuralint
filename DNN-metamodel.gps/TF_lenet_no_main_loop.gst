...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="TF_lenet_no_main_loop">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
        ...
        <node id="n37">
            <attr name="layout">
                <string>62 129 150 90</string>
            </attr>
        </node>
        <node id="n38">
            <attr name="layout">
                <string>194 310 184 90</string>
            </attr>
        </node>
        <node id="n39">
            <attr name="layout">
        ...
        <edge from="n37" to="n37">
            <attr name="label">
                <string>let:loop_line_end = int:0</string>
            </attr>
        </edge>
        ...
        <edge from="n37" to="n37">
            <attr name="label">
                <string>let:loop_line_start = int:0</string>
            </attr>
        </edge>
