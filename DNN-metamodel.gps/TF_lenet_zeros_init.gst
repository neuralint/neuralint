...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="TF_lenet_zeros_init">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
        ...
        <node id="n35">
            <attr name="layout">
                <string>79 105 150 90</string>
            </attr>
        </node>
        <node id="n36">
            <attr name="layout">
                <string>75 389 184 90</string>
            </attr>
        </node>
        <node id="n37">
            <attr name="layout">
                <string>259 214 85 36</string>
            </attr>
        </node>
        <node id="n38">
            <attr name="layout">
                <string>231 319 108 54</string>
            </attr>
        </node>
        <node id="n39">
            <attr name="layout">
                <string>41 266 102 36</string>
            </attr>
        </node>
        <edge from="n0" to="n35">
            <attr name="label">
