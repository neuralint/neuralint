...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="TF_lenet_constant_init">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
        ...
        <node id="n35">
            <attr name="layout">
                <string>111 81 150 90</string>
            </attr>
        </node>
        <node id="n36">
            <attr name="layout">
                <string>115 436 184 90</string>
            </attr>
        </node>
        <node id="n37">
            <attr name="layout">
                <string>103 311 85 36</string>
            </attr>
        </node>
        <node id="n38">
            <attr name="layout">
                <string>229 228 108 54</string>
            </attr>
        </node>
        <node id="n39">
            <attr name="layout">
                <string>19 237 102 36</string>
            </attr>
        </node>
        <edge from="n0" to="n35">
            <attr name="label">
        ...
        <edge from="n35" to="n35">
            <attr name="label">
                <string>let:location_of_initializer = int:68</string>
            </attr>
        </edge>
        <edge from="n35" to="n35">
            <attr name="label">
                <string>let:loop_line_start = int:69</string>
            </attr>
        </edge>
        ...
        <edge from="n35" to="n35">
            <attr name="label">
                <string>let:loop_line_end = int:94</string>
            </attr>
        </edge>
        <edge from="n35" to="n35">
            <attr name="label">
