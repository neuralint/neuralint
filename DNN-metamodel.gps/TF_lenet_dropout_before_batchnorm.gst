...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="TF_lenet_dropout_before_batchnorm">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
        ...
        <edge from="n42" to="n42">
            <attr name="label">
                <string>let:loop_line_end = int:97</string>
            </attr>
        </edge>
        <edge from="n42" to="n42">
            <attr name="label">
                <string>let:loop_line_start = int:72</string>
            </attr>
        </edge>
        ...
        <edge from="n42" to="n42">
            <attr name="label">
                <string>let:location_of_initializer = int:71</string>
            </attr>
        </edge>
        <edge from="n42" to="n46">
            <attr name="label">
                <string>has</string>
            </attr>
        </edge>
