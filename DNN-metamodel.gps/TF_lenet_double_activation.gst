...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
	<graph role="graph" edgeids="false" edgemode="directed" id="start1">
        ...
        <node id="n30">
            <attr name="layout">
                <string>2762 9 91 108</string>
            </attr>
        </node>
        <node id="n31">
            <attr name="layout">
                <string>2836 213 104 72</string>
            </attr>
        </node>
        <node id="n32">
            <attr name="layout">
                <string>2971 20 91 108</string>
            </attr>
        </node>
        <node id="n33">
            <attr name="layout">
                <string>2966 333 129 72</string>
            </attr>
        </node>
        <node id="n34">
            <attr name="layout">
        ...
        <node id="n37">
            <attr name="layout">
                <string>3482 342 87 36</string>
            </attr>
        </node>
        <node id="n38">
            <attr name="layout">
                <string>3272 223 164 36</string>
            </attr>
        </node>
        <node id="n39">
            <attr name="layout">
                <string>3329 402 110 36</string>
            </attr>
        </node>
        <node id="n40">
            <attr name="layout">
                <string>3517 8 84 126</string>
            </attr>
        </node>
        <node id="n41">
            <attr name="layout">
                <string>3596 226 104 72</string>
            </attr>
        </node>
        <node id="n42">
            <attr name="layout">
                <string>3704 51 53 36</string>
            </attr>
        </node>
        <node id="n43">
            <attr name="layout">
                <string>142 98 150 90</string>
            </attr>
        </node>
        <node id="n44">
            <attr name="layout">
                <string>160 353 184 90</string>
            </attr>
        </node>
        <node id="n45">
            <attr name="layout">
                <string>147 281 85 36</string>
            </attr>
        </node>
        <node id="n46">
            <attr name="layout">
                <string>28 237 108 54</string>
            </attr>
        </node>
        <node id="n47">
            <attr name="layout">
                <string>439 457 102 36</string>
            </attr>
        </node>
		<edge from="n0" to="n0">
			<attr name="label">
		...
		<edge from="n13" to="n13">
			<attr name="label">
				<string>let:type = string:"maxpooling2d"</string>
			</attr>
		</edge>
		<edge from="n13" to="n13">
			<attr name="label">
