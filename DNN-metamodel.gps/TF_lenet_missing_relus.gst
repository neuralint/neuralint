...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="TF_lenet_missing_relus">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
        ...
        <node id="n31">
            <attr name="layout">
                <string>75 105 150 90</string>
            </attr>
        </node>
        <node id="n32">
            <attr name="layout">
                <string>10 285 184 90</string>
            </attr>
        </node>
        <node id="n33">
            <attr name="layout">
                <string>240 397 85 36</string>
            </attr>
        </node>
        <node id="n34">
            <attr name="layout">
                <string>316 128 108 54</string>
            </attr>
        </node>
        <node id="n35">
            <attr name="layout">
                <string>262 249 102 36</string>
            </attr>
        </node>
        <edge from="n0" to="n1">
            <attr name="label">
