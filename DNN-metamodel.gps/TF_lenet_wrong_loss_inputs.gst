...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="TF_lenet_wrong_loss_inputs">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
        ...
        <node id="n34">
            <attr name="layout">
                <string>3162 -3 84 126</string>
            </attr>
        </node>
        <node id="n35">
            <attr name="layout">
                <string>3250 187 128 72</string>
            </attr>
        </node>
        <node id="n36">
            <attr name="layout">
                <string>3361 42 53 36</string>
            </attr>
        </node>
        <node id="n37">
            <attr name="layout">
        ...
        <node id="n40">
            <attr name="layout">
                <string>-54 -27 108 54</string>
            </attr>
        </node>
        <node id="n41">
            <attr name="layout">
                <string>293 150 102 36</string>
            </attr>
        </node>
        <edge from="n0" to="n0">
            <attr name="label">
