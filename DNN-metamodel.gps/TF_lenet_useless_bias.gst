...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="TF_lenet_useless_bias">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
        ...
        <node id="n21">
            <attr name="layout">
                <string>2092 204 120 36</string>
            </attr>
        </node>
        <node id="n22">
            <attr name="layout">
                <string>2338 -30 84 180</string>
            </attr>
        </node>
        <node id="n23">
            <attr name="layout">
                <string>2216 143 141 126</string>
            </attr>
        </node>
        <node id="n24">
            <attr name="layout">
                <string>2313 237 98 144</string>
            </attr>
        </node>
        <node id="n25">
            <attr name="layout">
                <string>2395 211 88 36</string>
            </attr>
        </node>
        <node id="n26">
            <attr name="layout">
        ...
        <node id="n31">
            <attr name="layout">
                <string>2955 177 104 72</string>
            </attr>
        </node>
        <node id="n32">
            <attr name="layout">
                <string>2842 223 91 108</string>
            </attr>
        </node>
        <node id="n33">
            <attr name="layout">
                <string>3086 217 120 36</string>
            </attr>
        </node>
        <node id="n34">
            <attr name="layout">
        ...
        <node id="n35">
            <attr name="layout">
                <string>3257 196 115 54</string>
            </attr>
        </node>
        <node id="n36">
            <attr name="layout">
                <string>3346 -3 84 126</string>
            </attr>
        </node>
        <node id="n37">
            <attr name="layout">
                <string>3495 339 87 36</string>
            </attr>
        </node>
        <node id="n38">
            <attr name="layout">
                <string>3494 270 164 36</string>
            </attr>
        </node>
        <node id="n39">
            <attr name="layout">
                <string>3387 325 110 36</string>
            </attr>
        </node>
        <node id="n40">
            <attr name="layout">
                <string>3728 206 53 36</string>
            </attr>
        </node>
        <node id="n41">
            <attr name="layout">
                <string>104 101 150 90</string>
            </attr>
        </node>
        <node id="n42">
            <attr name="layout">
                <string>180 273 184 90</string>
            </attr>
        </node>
        <node id="n43">
            <attr name="layout">
                <string>96 378 85 36</string>
            </attr>
        </node>
        <node id="n44">
            <attr name="layout">
                <string>11 260 108 54</string>
            </attr>
        </node>
        <node id="n45">
            <attr name="layout">
                <string>342 168 102 36</string>
            </attr>
        </node>
        <edge from="n0" to="n0">
            <attr name="label">
