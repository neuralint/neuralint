...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="TF_lenet_inv_amount_pooling">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
        ...
        <node id="n37">
            <attr name="layout">
                <string>83 106 150 90</string>
            </attr>
        </node>
        <node id="n38">
            <attr name="layout">
                <string>168 266 185 90</string>
            </attr>
        </node>
        <node id="n39">
            <attr name="layout">
                <string>57 369 85 36</string>
            </attr>
        </node>
        <edge from="n0" to="n0">
            <attr name="label">
