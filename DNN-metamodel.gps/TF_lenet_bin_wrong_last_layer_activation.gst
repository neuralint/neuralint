...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="TF_lenet_bin_wrong_last_layer_activation">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
        ...
        <node id="n34">
            <attr name="layout">
                <string>3128 10 124 90</string>
            </attr>
        </node>
        <node id="n35">
            <attr name="layout">
                <string>3241 202 128 72</string>
            </attr>
        </node>
        <node id="n36">
            <attr name="layout">
                <string>3338 40 124 36</string>
            </attr>
        </node>
        <node id="n37">
            <attr name="layout">
                <string>85 124 150 90</string>
            </attr>
        </node>
        <node id="n38">
            <attr name="layout">
                <string>38 283 180 90</string>
            </attr>
        </node>
        <node id="n39">
            <attr name="layout">
                <string>249 278 85 36</string>
            </attr>
        </node>
        <node id="n40"/>
        <node id="n41"/>
