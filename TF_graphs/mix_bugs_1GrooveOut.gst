...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="s27">
        <node id="n36"/>
        <node id="n34"/>
        <node id="n39"/>
        <node id="n17"/>
        ...
        <edge from="n144" to="n144">
            <attr name="label">
                <string>flag:f005</string>
            </attr>
        </edge>
        <edge from="n144" to="n144">
            <attr name="label">
                <string>flag:f016</string>
            </attr>
        </edge>
